    ...
    with Progress(console=console) as progress:
        ...
        for webpage in webpages:
            ...
            if page_response.status_code != 200: # <2>
                ...
                size: int | None = page_response.headers.get("Content-Length", len(page_response.content)) # <3>
    ...
    with Progress(console=console) as progress:
        ...
        for webpage in webpages:
            ...
            if page_response.status_code != 200:
                ...
                size: int | None = page_response.headers.get("Content-Length", len(page_response.content))
                page_task = progress.add_task(f"Laster ned [italic magenta]{webpage}[/]", total=size)
